...
<table align="center">
    <tbody>
        ...
        <tr>
            ...
            <td>
                <img src="./Logos/DroptopFourLogo_gif_1.gif" alt="Droptop Four Animated Logo" width="250"/>
            </td>
            <td>
                <img src="./Logos/DroptopFourLogo_gif_2.gif" alt="Droptop Four Animated Logo" width="250"/>
            </td>
        </tr>
</table><br>
...
<table align="center">
    <tbody>
        ...
        <tr>
            <td>
                <img src="./Banners/DroptopBanner_tr.png" alt="Droptop Four Banner" width="250"/>
            </td>
            <td>
                <img src="./Banners/DroptopBanner1.bmp" alt="Droptop Four Banner" width="250"/>
            </td>
            <td>
                <img src="./Banners/DroptopBanner2.png" alt="Droptop Four Banner" width="250"/>
            </td>
        </tr>
        <tr>
            <td>
                <img src="./Banners/DroptopBanner3.png" alt="Droptop Four Banner" width="250"/>
            </td>
            <td>
                <img src="./Banners/DroptopBanner4.png" alt="Droptop Four Banner" width="250"/>
            </td>
            <td>
